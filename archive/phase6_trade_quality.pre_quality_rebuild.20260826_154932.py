...
MIN_CONFIDENCE = 75.0
# Phase 6 does NOT construct or require trade levels.
# R:R belongs to Phase 7 after actual entry/SL/TP construction.
...
def evaluate_candidate(item):
    ...
    # R:R deliberately does not exist at Phase 6.
    result.pop("rr", None)
    result.pop("phase6_rr", None)
